...
export default function HomePage() {
  return (
    <>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="promise-item p-6 bg-white rounded-lg shadow">
              ...
              <p className="text-dark-text text-sm">Your most finite resource is being drained by repetitive tasks, administrative drag, and the mental energy it takes to manage it all.</p>
            </div>
            {/* Focus */}
            <div className="promise-item p-6 bg-white rounded-lg shadow">
              ...
              <p className="text-dark-text text-sm">Information overload creates strategic fog, making it impossible to distinguish the urgent from the important.</p>
            </div>
            {/* Story */}
            <div className="promise-item p-6 bg-white rounded-lg shadow">
              ...
              <p className="text-dark-text text-sm">In the age of AI, the greatest risk is allowing your purpose and voice to be dictated by the algorithms of others.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Testimonial Section */}
      <section className="testimonial bg-light-bg py-20">
      ...
      {/* Final CTA */}
      <section className="final-cta py-20">
        <div className="container mx-auto px-6 text-center">
